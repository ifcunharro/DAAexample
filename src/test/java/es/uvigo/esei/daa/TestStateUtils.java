...
public final class TestStateUtils {
	...
	public static void initTestDatabase() throws SQLException {
		final String queries = new StringBuilder()
			...
			.append("ALTER TABLE `state` AUTO_INCREMENT = 1;")
			.append("INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0, 'AntÃ³n', 'Ã�lvarez');")
			.append("INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0, 'Ana', 'Amargo');")
			.append("INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0, 'Manuel', 'MartÃ­nez');")
			.append("INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0, 'MarÃ­a', 'MÃ¡rquez');")
			.append("INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0, 'Lorenzo', 'LÃ³pez');")
			...
			.append("INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0, 'Patricia', 'PÃ©rez');")
			.append("INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0, 'Juan', 'JimÃ©nez');")

...
INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0,'Antón','Pérez');
...
INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0,'Ana','María');
INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0,'María','Nuevo');
INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0,'Alba','Fernández');
INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0,'Asunción','Jiménez');

...
INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0, 'Lorenzo', 'Lòpez');
INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0, 'Laura', 'Laredo');
INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0, 'Perico', 'Palotes');
INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0, 'Patricia', 'Pèrez');
INSERT INTO `people` (`id`,`name`,`surname`) VALUES (0, 'Juan', 'Jimènez');
